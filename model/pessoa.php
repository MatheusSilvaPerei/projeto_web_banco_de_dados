...
// "Teste" para saber se os arquivos foram importados corretamente
require_once $_SERVER['DOCUMENT_ROOT'] . '/projeto_web_banco_de_dados/controller/conexao.php';

// Criação da classe pessoa e suas variáveis
class Pessoa{
    private $id;
    private $nome;
    private $endereco;
...
/*  Criação do metodo inserir, respectivamente, fazendo a inserção na tabela pessoa
*/
